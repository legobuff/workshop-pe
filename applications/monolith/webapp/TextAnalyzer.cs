...
namespace monolith
{
    public static class TextAnalyzer
    {
        ...
        public static List<KeyValuePair<string, float>> AnalyseTextAndUpdateCache(IMemoryCache memoryCache)
        {
        ...
        public static List<KeyValuePair<string, float>> GetTopWords(IMemoryCache memoryCache)
        {
            ...
            if (topWords != null) return topWords;

            // in case there is nothing in the cache, generate top words now
            return AnalyseTextAndUpdateCache(memoryCache);
        }
