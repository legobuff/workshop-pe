...
- Name: jenkins-slave
- Docker image: jenkinsci/jnlp-slave:3.26-1 **Note:** If the Slave *jnlp-slave:3.26-1* is not working for you, please replace it with`jenkinsci/jnlp-slave:alpine`
